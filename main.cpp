...
void join(char*& strFirst, char*& strSecond, int& sizeFirst, int sizeSecond) {
    ...
    if ((lengthFirst + lengthSecond) > sizeFirst-1) {
        ...
        join(strFirst, strSecond, sizeFirst, sizeSecond); */
    }
...
int main() {
    ...
    join(arrFirst, arrSecond, sizeFirst, sizeSecond);
